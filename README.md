...
Atualmente estudo:
- Domain Driven Desing Using JAVA
- Computational Thinking Using Python
- Front-End Design Engineering
- Software Engineering and Business Modal
- Projetos de Extensão
- Formação Social e Sustentabilidade

Meu objetivo é ganhar experiência prática com projetos reais e evoluir como desenvolvedor. 
<!-- Github stats from -->
